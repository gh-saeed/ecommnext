<div class="allFooter2">
    <div class="width">
        <div class="topFooter">
            <div class="option">
                <div class="pic">
                    <img src="/img/safe.svg" alt="پرداخت امن">
                </div>
                <div class="body">پرداخت امن از درگاه بانکی</div>
            </div>
            <div class="option">
                <div class="pic">
                    <img src="/img/original.png" alt="تضمین بازگشت وجه">
                </div>
                <div class="body">تضمین بازگشت وجه</div>
            </div>
            <div class="option">
                <div class="pic">
            ...
            <div class="option">
                ...
                <div class="body">پشتیبانی آنلاین و تلفنی</div>
            </div>
        </div>
        <div class="centerFooter">
            ...
            <div class="left">
                ...
                <div class="item">
                    ...
                    <div class="trustFooter" style="max-height: 8rem;display:flex;">
                        <div>{!! \App\Models\Setting::where('key' , 'etemad')->pluck('value')->first() !!}</div>
                        <div>{!! \App\Models\Setting::where('key' , 'fanavari')->pluck('value')->first() !!}</div>
                    </div>
                </div>
            </div>
        </div>
