...
@section('content')
    <div class="allBecomeSeller width">
        <form method="post" action="/become-seller" class="allBecomeUserInfo">
            ...
            <input type="hidden" name="state1" value="تهران">
            <input type="hidden" name="city1" value="تهران">
            <div class="sellerType">
                <h3>حقیقی یا حقوقی هستید؟</h3>
                <select name="seller">
            ...
            <div class="contactSeller">
                ...
                <div class="personInfoItems">
                    ...
                    <div class="personInfoItem">
                        ...
                        <input type="text" placeholder="{{__('messages.seller_phone')}}" name="landlinePhone">
                        @error('landlinePhone')
                        <div class="alert">{{__('messages.seller_necessary')}}</div>
                        @enderror
                    </div>
            ...
            <div class="contactSeller">
                ...
                <div class="personInfoItems">
                    <div class="personInfoItem">
                        ...
                        <input type="text" placeholder="{{__('messages.seller_user')}}" value="{{auth()->user()?auth()->user()->name:''}}" name="name">
                        @error('name')
                        <div class="alert">{{__('messages.seller_necessary')}}</div>
                        @enderror
                    </div>
                    <div class="personInfoItem">
                        <h4>آدرس اینترنتی غرفه‌ت چی باشه؟</h4>
                        <input type="text" style="direction: ltr" placeholder="{{url('/@آدرس')}}" value="{{auth()->user()?auth()->user()->slug:''}}" name="slug">
                        @error('slug')
                        <div class="alert">{{__('messages.seller_necessary')}}</div>
                        @enderror
                    </div>
                ...
                <ul>
                    <li>
                        <label for="percent">
                            ...
                            میزان کارمزد از هر تراکنش موفق بین
                            {{\App\Models\Category::where('type' , 0)->min('percent')}}
                            تا
                            {{\App\Models\Category::where('type' , 0)->max('percent')}}
                            درصد می‌باشد.
                        </label>
                    </li>
                    <li>
                        <label for="payback">
                            <input type="checkbox" name="payback" id="payback">
                            تسویه حساب پس از دریافت کالا و ثبت رضایت مشتری انجام می‌شود. مشتری
                            {{\App\Models\Setting::where('key' , 'checkoutCharge')->pluck('value')->first()}}
                            روز برای اعلام رضایت فرصت دارد.
                        </label>
                    </li>
                    <li>
                        <label for="role">
                            <input type="checkbox" name="role" id="role">
                            شرایط و قوانین غرفه داری را مطالعه کردید و آن را پذیرفته اید
                        </label>
                    </li>
                </ul>
            </div>
            <div class="buttons">
                <button disabled>{{__('messages.submit')}}</button>
            </div>
        </form>
    </div>
@endsection
    ...
    <script>
        $(document).ready(function(){
            ...
            $('input[type="checkbox"]').on('change', function() {
                if ($('#percent').is(':checked') && $('#payback').is(':checked') && $('#role').is(':checked')) {
                    $('.buttons button').prop('disabled', false);
                } else {
                    $('.buttons button').prop('disabled', true);
                }
            });
            $(".allBecomeSeller select[name='state']").val('تهران');
            $(".city1").show();
            $(".allBecomeSeller select[name='city']").on('change' , function(e){
                $("input[name='city1']").val($(this).val());
            })
            $(".allBecomeSeller select[name='state']").on('change' , function(e){
                $("select[name='city']").hide();
                $("input[name='state1']").val($(this).val());
                if(this.value == 'تهران'){
                    $('.allBecomeSeller .city1').show();
                    $("input[name='city1']").val($('.allBecomeSeller .city1').val());
                }
                if(this.value == 'خراسان رضوی'){
                    $('.allBecomeSeller .city2').show();
                    $("input[name='city1']").val($('.allBecomeSeller .city2').val());
                }
                if(this.value == 'اصفهان'){
                    $('.allBecomeSeller .city3').show();
                    $("input[name='city1']").val($('.allBecomeSeller .city3').val());
                }
                if(this.value == 'فارس'){
                    $('.allBecomeSeller .city4').show();
                    $("input[name='city1']").val($('.allBecomeSeller .city4').val());
                }
                if(this.value == 'خوزستان'){
                    $('.allBecomeSeller .city5').show();
                    $("input[name='city1']").val($('.allBecomeSeller .city5').val());
                }
                if(this.value == 'آذربایجان شرقی'){
                    $('.allBecomeSeller .city6').show();
                    $("input[name='city1']").val($('.allBecomeSeller .city6').val());
                }
                if(this.value == 'مازندران'){
                    $('.allBecomeSeller .city7').show();
                    $("input[name='city1']").val($('.allBecomeSeller .city7').val());
                }
                if(this.value == 'آذربایجان غربی'){
                    $('.allBecomeSeller .city8').show();
                    $("input[name='city1']").val($('.allBecomeSeller .city8').val());
                }
                if(this.value == 'کرمان'){
                    $('.allBecomeSeller .city9').show();
                    $("input[name='city1']").val($('.allBecomeSeller .city9').val());
                }
                if(this.value == 'سیستان و بلوچستان'){
                    $('.allBecomeSeller .city10').show();
                    $("input[name='city1']").val($('.allBecomeSeller .city10').val());
                }
                if(this.value == 'البرز'){
                    $('.allBecomeSeller .city11').show();
                    $("input[name='city1']").val($('.allBecomeSeller .city11').val());
                }
                if(this.value == 'گیلان'){
                    $('.allBecomeSeller .city12').show();
                    $("input[name='city1']").val($('.allBecomeSeller .city12').val());
                }
                if(this.value == 'کرمانشاه'){
                    $('.allBecomeSeller .city13').show();
                    $("input[name='city1']").val($('.allBecomeSeller .city13').val());
                }
                if(this.value == 'گلستان'){
                    $('.allBecomeSeller .city14').show();
                    $("input[name='city1']").val($('.allBecomeSeller .city14').val());
                }
                if(this.value == 'هرمزگان'){
                    $('.allBecomeSeller .city15').show();
                    $("input[name='city1']").val($('.allBecomeSeller .city15').val());
                }
                if(this.value == 'لرستان'){
                    $('.allBecomeSeller .city16').show();
                    $("input[name='city1']").val($('.allBecomeSeller .city16').val());
                }
                if(this.value == 'همدان'){
                    $('.allBecomeSeller .city17').show();
                    $("input[name='city1']").val($('.allBecomeSeller .city17').val());
                }
                if(this.value == 'کردستان'){
                    $('.allBecomeSeller .city18').show();
                    $("input[name='city1']").val($('.allBecomeSeller .city18').val());
                }
                if(this.value == 'مرکزی'){
                    $('.allBecomeSeller .city19').show();
                    $("input[name='city1']").val($('.allBecomeSeller .city19').val());
                }
                if(this.value == 'قم'){
                    $('.allBecomeSeller .city20').show();
                    $("input[name='city1']").val($('.allBecomeSeller .city20').val());
                }
                if(this.value == 'قزوین'){
                    $('.allBecomeSeller .city21').show();
                    $("input[name='city1']").val($('.allBecomeSeller .city21').val());
                }
                if(this.value == 'اردبیل'){
                    $('.allBecomeSeller .city22').show();
                    $("input[name='city1']").val($('.allBecomeSeller .city22').val());
                }
                if(this.value == 'بوشهر'){
                    $('.allBecomeSeller .city23').show();
                    $("input[name='city1']").val($('.allBecomeSeller .city23').val());
                }
                if(this.value == 'یزد'){
                    $('.allBecomeSeller .city24').show();
                    $("input[name='city1']").val($('.allBecomeSeller .city24').val());
                }
                if(this.value == 'زنجان'){
                    $('.allBecomeSeller .city25').show();
                    $("input[name='city1']").val($('.allBecomeSeller .city25').val());
                }
                if(this.value == 'چهارمحال و بختیاری'){
                    $('.allBecomeSeller .city26').show();
                    $("input[name='city1']").val($('.allBecomeSeller .city26').val());
                }
                if(this.value == 'خراسان شمالی'){
                    $('.allBecomeSeller .city27').show();
                    $("input[name='city1']").val($('.allBecomeSeller .city27').val());
                }
                if(this.value == 'خراسان جنوبی'){
                    $('.allBecomeSeller .city28').show();
                    $("input[name='city1']").val($('.allBecomeSeller .city28').val());
                }
                if(this.value == 'کهگیلویه و بویراحمد'){
                    $('.allBecomeSeller .city29').show();
                    $("input[name='city1']").val($('.allBecomeSeller .city29').val());
                }
                if(this.value == 'سمنان'){
                    $('.allBecomeSeller .city30').show();
                    $("input[name='city1']").val($('.allBecomeSeller .city30').val());
                }
                if(this.value == 'ایلام'){
                    $('.allBecomeSeller .city31').show();
                    $("input[name='city1']").val($('.allBecomeSeller .city31').val());
                }
            });
