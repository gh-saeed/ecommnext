        ...
        <div class="container1" style="{{count($getCart[0]) == 0 ? 'display:none' : ''}}">
                        ...
                        <div class="item">
                            ...
                            <div class="botItem">
                                <div class="operations">
                                    ...
                                    <ul>
                                        <li><div class="move" id="{{$item['id']}}">انتقال به سبد بعدی</div></li>
            ...
            <div class="left">
                <div class="box">
                    ...
                    <a class="move" href="/checkout">تسویه حساب</a>
                </div>
...
@section('scriptPage')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(document).on('click','.carts .item .operation',function(){
