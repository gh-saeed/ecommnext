...
@section('content')
    <main class="allSellerSingle width">
        <div class="top">
            ...
            <div class="more">
                <div class="tabs">
                    <a href="/vendor/{{$user->slug}}" class="tab" data-num="home1">
                        خانه
                    </a>
                    <div class="tab" data-num="product1">
                        محصولات
                        <div class="num numP">0</div>
                    </div>
                    <div class="tab active" data-num="comment1">
                        تجربه مشتریان
                ...
                <div class="options">
                    ...
                    <div class="option">
                        <div class="body2">{{\App\Models\Report::where('user_id',auth()->id())->where('status',1)->count()}}</div>
                        <div class="title2">گزارش</div>
                    </div>
                </div>
            </div>
        </div>
        <div class="allProductArchive product1 container1" style="display:none;">
