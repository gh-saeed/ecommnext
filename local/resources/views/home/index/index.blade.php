...
@section('title',\App\Models\Setting::where('key' , 'title')->pluck('value')->first())
@section('content')
    <main class="allIndex">
        <h1 class="hiddenSeo">{{\App\Models\Setting::where('key' , 'name')->pluck('value')->first()}}</h1>
        <h2 class="hiddenSeo">{{\App\Models\Setting::where('key' , 'title')->pluck('value')->first()}}</h2>
