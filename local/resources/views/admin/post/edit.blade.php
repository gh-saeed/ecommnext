            ...
            <div id="infoProduct" class="allCreatePostData">
                <div class="allCreatePostSubject">
                    ...
                    <div class="allCreatePostItem">
                        ...
                        <input type="text" name="prepare" value="{{ old('prepare', $posts->prepare) }}" placeholder="مثال : 2">
                    </div>
                    <div class="allCreatePostItem">
                        <label>تخمین زمان تحویل* :</label>
                        <input type="text" name="time" value="{{ old('time', $posts->time) }}" placeholder="مثال : 2">
                    </div>
                    <div class="allCreatePostItem">
                        <label>توضیحات :</label>
                ...
                <div class="allCreatePostDetails">
                    <div class="allCreatePostDetail">
                        ...
                        <div class="allCreatePostDetailItems">
                            <div class="allCreatePostDetailItem type1">
                                <label>وزن :</label>
            ...
            <div id="calcProduct" class="allCreatePostData" style="display: none">
                <div class="allCreatePostSubject">
                    ...
                    <div class="allCreatePostItem">
                        ...
                        <input type="text" name="price" value="{{$posts->price}}" placeholder="قیمت را وارد کنید">
