        ...
        <div class="createWidget">
            ...
            <div class="createItems">
                <div class="createItem change1 change2">
                    ...
                    <input type="text" placeholder="عنوان را وارد کنید" name="title" value="{{$widget->title}}">
                </div>
                <div class="createItem change1 change3">
                    <label>عنوان مشاهده بیشتر :</label>
                    <input type="text" placeholder="عنوان را وارد کنید" name="more" value="{{$widget->more}}">
                </div>
                <div class="createItem change1 change5">
                    <label>توضیحات :</label>
                    <input type="text" placeholder="توضیحات را وارد کنید" name="description" value="{{$widget->description}}">
                </div>
                <div class="createItem change1 change7">
                    <label>لینک مشاهده بیشتر :</label>
                    <input type="text" placeholder="لینک را وارد کنید" name="slug" value="{{$widget->slug}}">
                </div>
                <div class="createItem change1 change8">
                    <label>آدرس تصویر :</label>
                    <input type="text" placeholder="آدرس را وارد کنید" name="background" value="{{$widget->background}}">
                </div>
                <div class="createItem change1 change9">
                    <label>تعداد نمایش :</label>
                    <input type="text" placeholder="تعداد را وارد کنید" name="count" value="{{$widget->count}}">
                </div>
...
@section('scripts3')
    <script>
        $(document).ready(function(){
            ...
            var userId = {!! json_encode($userId, JSON_HEX_TAG) !!};
