...
<div class="createDocumentPanel">
    <form action="/admin/document/{{$documents->id}}/edit" method="post" class="createDocumentPanelItems">
        @csrf
        <input type="hidden" name="state1" value="{{$documents->user->state}}">
        <input type="hidden" name="city1" value="{{$documents->user->city}}">
        <div class="allBecomeUserInfo">
            ...
            <div class="contactSeller">
                ...
                <div class="personInfoItems">
                    <div class="personInfoItem">
                        <h4>تلفن ثابت</h4>
                        <input type="text" placeholder="پیش شماره بدون صفر + شماره" name="landlinePhone">
                    </div>
                    <div class="personInfoItem">
                        <h4>شماره تماس</h4>
            ...
            <div class="contactSeller">
                ...
                <div class="personInfoItems">
                    <div class="personInfoItem">
                        <h4>نام غرفه</h4>
                        <input type="text" placeholder="نام غرفه" value="{{$documents->user->name}}" name="name">
                        @error('name')
                        <div class="alert">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="personInfoItem">
                        <h4>آدرس اینترنتی غرفه</h4>
                        <input type="text" style="direction: ltr" placeholder="{{url('/@آدرس')}}" name="slug" value="{{$documents->user->slug}}">
                        @error('slug')
                        <div class="alert">{{ $message }}</div>
                        @enderror
                    </div>
...
@section('scripts')
    <script>
        $(document).ready(function(){
            ...
            if(documents.user.category.length){
                $("select[name='category']").val(documents.user.category[0].id);
            }
            $(".allBecomeUserInfo select[name='state']").val(documents.user.state);
            getState(documents.user.state,documents.user.city);
            $(".allBecomeUserInfo select[name='city']").on('change' , function(e){
                $("input[name='city1']").val($(this).val());
            })
            $(".allBecomeUserInfo select[name='state']").on('change' , function(e){
                getState(this.value,'');
                $(".allBecomeUserInfo input[name='state1']").val(this.value);
            });
            function getState(value1,city1){
                $("select[name='city']").hide();
                if(value1 == 'تهران'){
                    $('.allBecomeUserInfo .city1').show();
                    $('.allBecomeUserInfo .city1').val(city1);
                }
                if(value1 == 'خراسان رضوی'){
                    $('.allBecomeUserInfo .city2').show();
                    $('.allBecomeUserInfo .city2').val(city1);
                }
                if(value1 == 'اصفهان'){
                    $('.allBecomeUserInfo .city3').show();
                    $('.allBecomeUserInfo .city3').val(city1);
                }
                if(value1 == 'فارس'){
                    $('.allBecomeUserInfo .city4').show();
                    $('.allBecomeUserInfo .city4').val(city1);
                }
                if(value1 == 'خوزستان'){
                    $('.allBecomeUserInfo .city5').show();
                    $('.allBecomeUserInfo .city5').val(city1);
                }
                if(value1 == 'آذربایجان شرقی'){
                    $('.allBecomeUserInfo .city6').show();
                    $('.allBecomeUserInfo .city6').val(city1);
                }
                if(value1 == 'مازندران'){
                    $('.allBecomeUserInfo .city7').show();
                    $('.allBecomeUserInfo .city7').val(city1);
                }
                if(value1 == 'آذربایجان غربی'){
                    $('.allBecomeUserInfo .city8').show();
                    $('.allBecomeUserInfo .city8').val(city1);
                }
                if(value1 == 'کرمان'){
                    $('.allBecomeUserInfo .city9').show();
                    $('.allBecomeUserInfo .city9').val(city1);
                }
                if(value1 == 'سیستان و بلوچستان'){
                    $('.allBecomeUserInfo .city10').show();
                    $('.allBecomeUserInfo .city10').val(city1);
                }
                if(value1 == 'البرز'){
                    $('.allBecomeUserInfo .city11').show();
                    $('.allBecomeUserInfo .city11').val(city1);
                }
                if(value1 == 'گیلان'){
                    $('.allBecomeUserInfo .city12').show();
                    $('.allBecomeUserInfo .city12').val(city1);
                }
                if(value1 == 'کرمانشاه'){
                    $('.allBecomeUserInfo .city13').show();
                    $('.allBecomeUserInfo .city13').val(city1);
                }
                if(value1 == 'گلستان'){
                    $('.allBecomeUserInfo .city14').show();
                    $('.allBecomeUserInfo .city14').val(city1);
                }
                if(value1 == 'هرمزگان'){
                    $('.allBecomeUserInfo .city15').show();
                    $('.allBecomeUserInfo .city15').val(city1);
                }
                if(value1 == 'لرستان'){
                    $('.allBecomeUserInfo .city16').show();
                    $('.allBecomeUserInfo .city16').val(city1);
                }
                if(value1 == 'همدان'){
                    $('.allBecomeUserInfo .city17').show();
                    $('.allBecomeUserInfo .city17').val(city1);
                }
                if(value1 == 'کردستان'){
                    $('.allBecomeUserInfo .city18').show();
                    $('.allBecomeUserInfo .city18').val(city1);
                }
                if(value1 == 'مرکزی'){
                    $('.allBecomeUserInfo .city19').show();
                    $('.allBecomeUserInfo .city19').val(city1);
                }
                if(value1 == 'قم'){
                    $('.allBecomeUserInfo .city20').show();
                    $('.allBecomeUserInfo .city20').val(city1);
                }
                if(value1 == 'قزوین'){
                    $('.allBecomeUserInfo .city21').show();
                    $('.allBecomeUserInfo .city21').val(city1);
                }
                if(value1 == 'اردبیل'){
                    $('.allBecomeUserInfo .city22').show();
                    $('.allBecomeUserInfo .city22').val(city1);
                }
                if(value1 == 'بوشهر'){
                    $('.allBecomeUserInfo .city23').show();
                    $('.allBecomeUserInfo .city23').val(city1);
                }
                if(value1 == 'یزد'){
                    $('.allBecomeUserInfo .city24').show();
                    $('.allBecomeUserInfo .city24').val(city1);
                }
                if(value1 == 'زنجان'){
                    $('.allBecomeUserInfo .city25').show();
                    $('.allBecomeUserInfo .city25').val(city1);
                }
                if(value1 == 'چهارمحال و بختیاری'){
                    $('.allBecomeUserInfo .city26').show();
                    $('.allBecomeUserInfo .city26').val(city1);
                }
                if(value1 == 'خراسان شمالی'){
                    $('.allBecomeUserInfo .city27').show();
                    $('.allBecomeUserInfo .city27').val(city1);
                }
                if(value1 == 'خراسان جنوبی'){
                    $('.allBecomeUserInfo .city28').show();
                    $('.allBecomeUserInfo .city28').val(city1);
                }
                if(value1 == 'کهگیلویه و بویراحمد'){
                    $('.allBecomeUserInfo .city29').show();
                    $('.allBecomeUserInfo .city29').val(city1);
                }
                if(value1 == 'سمنان'){
                    $('.allBecomeUserInfo .city30').show();
                    $('.allBecomeUserInfo .city30').val(city1);
                }
                if(value1 == 'ایلام'){
                    $('.allBecomeUserInfo .city31').show();
                    $('.allBecomeUserInfo .city31').val(city1);
                }
            }
            if(documents.user.genuine){
                ...
                $("input[name='landlinePhone']").val(documents.user.genuine.landlinePhone);
            }
