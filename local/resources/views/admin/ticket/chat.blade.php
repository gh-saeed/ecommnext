...
{{--        <div class="filemanager" style="display:none;">--}}
                    ...
                    success: function (data) {
                        ...
                        $.each(data,function (){
                            $('.allTickets .container .list').append(
                                ...
                                <div class="about">
                                    <div class="name">${this.user?this.user.name:'-'}
                ...
                if(ticket >= 1){
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            $('.chat-header img').attr('src',data.user?(data.user.profile?data.user.profile:'/img/user.png'):'/img/user.png');
                            ...
                            $('.chat .chat-history ul').append(
                                ...
                                '<span class="message-data-name" >'+(data.user?data.user.name:'-')+'</span>'+
