    ...
    <script>
        $(document).ready(function(){
            ...
            $("button[name='createPost']").click(function(event){
                ...
                var price = $(".allCreatePostDetailItem input[name='price']").val();
                ...
                $("#colors tr").each(function(){
                    if($(this).find("input").length >= 1) {
                        ...
                        $(this).find("input").each(function () {
                            ...
                            if (this.name == 'count') {
                                color.count = this.value?this.value:0;
                            }
                            if (this.name == 'price') {
                                color.price = this.value?this.value:0;
                            }
                        })
                        colors.push(color);
                    }
                ...
                $("#sizes tr").each(function(){
                    if($(this).find("input").length >= 1) {
                        ...
                        $(this).find("input").each(function () {
                            ...
                            if (this.name == 'count') {
                                size.count = this.value?this.value:0;
                            }
                            if (this.name == 'price') {
                                size.price = this.value?this.value:0;
                            }
                        })
                        sizes.push(size);
                    }
            ...
            $('#addProperty').click(function (){
                $('#properties').append(
                    $('<tr><td><input type="text" name="title" placeholder="'+product_property2+'"></td><td><input name="body" placeholder="'+body3+'"/></td><td><i id="deleteProperty"><svg class="icon"><use xlink:href="#trash"></use></svg></i></td></tr>')
