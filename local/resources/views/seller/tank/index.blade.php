    ...
    <div class="allTank">
        <div class="topProductIndex">
            <div class="right">
                ...
                <span>/</span>
                <a href="/seller/tank">همه انبار ها</a>
            </div>
            <div class="allTopTableItem">
                ...
                <div class="filterItems">
                    ...
                    <form method="GET" action="/seller/tank" class="filterContent" style="display: none">
        ...
        <div class="allReturnedPay">
            @foreach($tanks as $item)
                <div class="postItem" id="{{$item->id}}">
                    ...
                    <a class="show" target="_blank" href="/seller/tank/{{$item->id}}/edit" title="جزییات">جزییات و ویرایش انبار</a>
                    <div class="delete" id="{{$item->id}}">حذف انبار</div>
                </div>
            @endforeach
        </div>
        <form class="tankCreate" action="/seller/tank" method="post" style="display:none;">
            @csrf
    ...
    <script>
        $(document).ready(function(){
            ...
            $('.allReturnedPay .postItem').on('click' , '.delete' ,function(){
                post = this.id;
                $('.popUp').show();
                $('.buttonsPop form').attr('action' , '/seller/tank/' + post+'/delete');
            })
        })
    </script>
@endsection
