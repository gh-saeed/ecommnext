...
@section('content')
    <div class="allTank">
        ...
        @endif
        <form class="createTank" method="post" action="/seller/tank/{{$tank->id}}/edit" style="grid-template-columns: 1fr auto">
            @csrf
        ...
        <form class="createTank" method="post" action="/seller/tank/add-detail">
            @csrf
